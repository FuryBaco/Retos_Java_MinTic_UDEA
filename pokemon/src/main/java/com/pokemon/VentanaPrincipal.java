...
public class VentanaPrincipal {
    ...
    public VentanaPrincipal(JPanel ventanaPrincipal, JButton buttonVentanaEmergente, JTextField nombreUsuarioTextField,
            JButton bienvenidaUsuarioButton, JLabel mensajeBienvenidaUsuarioLabel, JTextField txtUsuario,
            JPasswordField txtPassword, JButton btnIngresar, JCheckBox chkVerPassword) {
        this.ventanaPrincipal = ventanaPrincipal;
        this.buttonVentanaEmergente = buttonVentanaEmergente;
        this.nombreUsuarioTextField = nombreUsuarioTextField;
        this.bienvenidaUsuarioButton = bienvenidaUsuarioButton;
        this.mensajeBienvenidaUsuarioLabel = mensajeBienvenidaUsuarioLabel;
        this.txtUsuario = txtUsuario;
        this.txtPassword = txtPassword;
        this.btnIngresar = btnIngresar;
        this.chkVerPassword = chkVerPassword;
    }
